					...
					<a class="nav-link " href="#;" role="button" data-bs-toggle="dropdown">
						<div class="header-info2 d-flex align-items-center">
							...
							<div class="d-flex align-items-center sidebar-info">
								<div>
									<span
										class="font-w400 d-block"><?php echo $students_info['fullname'] ?? 'Guest'; ?></span>
									<small
						...
						<div class="clearfix">
							...
							<?php endif; ?>
											...
											<div class="author-info">
												<h6 class="title"><?php echo $students_info['fullname'] ?? 'Guest'; ?></h6>
												<span><?php echo $students_info['regNo'] ?? 'Guest'; ?></span>
											</div>
										</div>
									</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-sm-6 m-b30">
											...
											<input type="text" class="form-control" value="<?php echo $students_info['firstName'] ?? 'Guest'; ?>" readonly>
										</div>
										<div class="col-sm-6 m-b30">
											<label class="form-label">Middle Name</label>
											<input type="text" class="form-control" value="<?php echo $students_info['middleName'] ?? 'Guest'; ?>" readonly >
										</div>
										<div class="col-sm-6 m-b30">
											<label class="form-label">Last Name</label>
											<input type="text" class="form-control" value="<?php echo $students_info['lastName'] ?? 'Guest'; ?>" readonly>
										</div>
										<div class="col-sm-6 m-b30">
											<label class="form-label">Gender</label>
											<input type="text" class="form-control" value="<?php echo $students_info['gender'] ?? 'Guest'; ?>" readonly>
										</div>
										<div class="col-sm-6 m-b30">
											<label class="form-label">Email Address </label>
											<input type="text" class="form-control" value="<?php echo $students_info['email'] ?? 'Guest'; ?>" readonly>
											
										</div>
										<div class="col-sm-6 m-b30">
											<div class="example">
												<label class="form-label">Phone Number</label>
												<input type="text" class="form-control" value="<?php echo $students_info['contactNo'] ?? 'Guest'; ?>" readonly>
											</div>	
										</div>
